...
const QuizOver = React.forwardRef((props, ref) => {
  ...
  const hash = "70c03a80405f5ea56e7d844fa79d7275";
  ...
  const resultInModal = !loading ? (
    <Fragment>
      ...
      <div className="modalBody">
        ...
        <h3>Description</h3>
        {
          characterInfos.data.results[0].description ? <p>{characterInfos.data.results[0].description}</p> : <p>Description indisponible...</p>
        }
        <h3>Plus d'infos</h3>
        {
  ...
  return (
    <Fragment>
      ...
      <hr />
      <p>Les réponses aux questions pasées: </p>
